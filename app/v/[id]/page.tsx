...
const jsonLd = {
        ...
        url: `https://videobokepjepang.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://videobokepjepang.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
